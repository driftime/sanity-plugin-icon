 ...
 * @public
 */
export type IconProps = Omit<ComponentProps<"svg">, "children"> & { value: SanityIcon | undefined };
 ...
 *
 * @param props - The stored icon, alongside any attributes the SVG should carry.
